...
public class ClienteDaoJDBC {
    ...
    public int insertar(Cliente cliente){
        ...
        //No usamos resulset, ya que no recuperamos info, sino que insertaremos info
        ...
        try {
            ...
            //El metodo stmt.exec... devuelve el num(int) de registros modificados
